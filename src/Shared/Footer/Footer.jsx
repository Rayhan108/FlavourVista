...
const Footer = () => {
  ...
  <aside>
   <img src={Logo} className="w-48" alt="" />
    <p className="font-thin mt-3 text-white">FlavourVista is reputed resturant<br/>always maintaining hygenic food since 2011</p>
  </aside> 
  <nav>
    <h6 className="footer-title text-white text-xl font-mono mt-20 md:mt-3">Social</h6> 
